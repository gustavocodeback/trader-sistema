...
class Propostas extends MY_Controller {
    ...
    */
	public function index() {
		...
		->onApply( 'Ações', function( $row, $key ) {
			echo '<a href="'.site_url( 'propostas/alterar/'.$row[$key] ).'" class="margin btn btn-xs btn-info"><span class="glyphicon glyphicon-pencil"></span></a>';
			echo '<a href="'.site_url( 'propostas/excluir/'.$row[$key] ).'" class="margin btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span></a>';            
		})
        ...
        $this->view->set( 'add_url', site_url( 'propostas/adicionar' ) );
    ...
    */
	public function index_func() {
        ...
        // seta a url para adiciona
        $this->view->set( 'add_url', site_url( 'propostas/adicionar' ) );
        $this->view->set( 'send_url', site_url( 'propostas/disparo' ) );
