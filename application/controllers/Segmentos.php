    ...
    */
	public function index() {
		...
		->onApply( 'Ações', function( $row, $key ) {
			echo '<a href="'.site_url( 'segmentos/alterar/'.$row['Código'] ).'" class="margin btn btn-xs btn-info"><span class="glyphicon glyphicon-pencil"></span></a>';
			echo '<a href="'.site_url( 'segmentos/excluir/'.$row['Código'] ).'" class="margin btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span></a>';            
		})
        ...
        $this->view->set( 'add_url', site_url( 'segmentos/adicionar' ) );
